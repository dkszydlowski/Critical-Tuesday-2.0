...
write.csv(DDJ_prepped, "./data/formatted data/HF data/ARIMA Paul stacked data for global DDJ 098 NOISY THINNED.csv", row.names = FALSE) # this is really 098
...
# check adf.test of the reuslting data
