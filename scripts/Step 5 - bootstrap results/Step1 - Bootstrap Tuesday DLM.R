#### Script for Bootstrapping the Tuesday DLM results
...
load(file='./results/DLMresult_HYLB_Tuesday_ALL_Chl_Predicted to Manual Scale 098 NOISY ARIMA.Rdata')
Fname = c('./results/bootstrapped results/DLM_boot_Tuesday 1000.Rdata')
