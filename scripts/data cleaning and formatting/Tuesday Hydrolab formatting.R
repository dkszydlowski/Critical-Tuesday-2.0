...
new.MARSS15 = read.csv("./scripts/MARSSing 2013 through 2015/2015_Tuesday_CHL_MARSS_2026_01_12.csv") %>% 
  mutate(Year = 2015, Lake = "T") 
new.MARSS14 = read.csv("./scripts/MARSSing 2013 through 2015/2014_Tuesday_CHL_MARSS_2026_01_09.csv") %>% 
  mutate(Year = 2014, Lake = "T")
new.MARSS13 = read.csv("./scripts/MARSSing 2013 through 2015/2013_Tuesday_CHL_MARSS_2026_01_09.csv") %>% 
...
# these data have pigments that are log-transformed (log10(x))
...
chl.t25 = read.csv("2025_Tuesday_CHL_MARSS_2026_01_19 DKS.csv")
chl.t24 = read.csv("2024_Tuesday_CHL_MARSS_2026_01_19 DKS.csv")
